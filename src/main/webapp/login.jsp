...
<tr height="73">
	...
	<td width="320" valign="top" background="images/6.png" rowspan="2" style="background-color: #ffffff;background-repeat: no-repeat;background-position: right bottom;">
		...
		<a href="<%=path %>/help/help_index.jsp" class="tit" target="_blank">帮  助</a>&nbsp;&nbsp;
		</td>
		</tr>
		</table>
		...
		String dcode = "BIOS";
		if(bl==false){ 
			dcode =SystemConfig.getParam("erp.sys.DefaultCode");
		}%>
		<tr>
		<td style="color:#167FC8" width="40">公司码</td>
		<td style="padding-left:10px;" nowrap>
		<input type="text" class="niceform" id="companycode" name="companycode" style="ime-mode:disabled; font-size:14px;font-variant: small-caps" value="<%=dcode %>"/>&nbsp;&nbsp;<a href="<%=path %>/help/help_error.jsp" title="什么是公司编码" target="_blank"><img src="images/whycompany.gif" border="0"/></a></td>
		</tr>
		<tr>
		<td style="color:#167FC8">用户名</td>
		<td style="padding-left:10px;" nowrap><input type="text" class="niceform" id="username" name="username" style="ime-mode:disabled;background:url('<%=request.getContextPath() %>/images/userimg.gif') no-repeat 1px;padding-left:20px; font-size:12px;width:155px;"/></td>
		</tr>
		<tr>
		...
		<td style="padding-left:10px;position:relative;" nowrap>
			...
			<input type="password" class="niceform" id="userpwd" name="userpwd" onkeypress="detectCapsLock();" onblur="hiddenTipsDiv();"  style="background:url('<%=request.getContextPath() %>/images/userpwdimg.gif') no-repeat 1px;padding-left:20px;font-size:12px;width:155px;"/>
		</td>
		</tr>
...
<table>
<tr>
<td style="color:#ffffff;font-size: 12px;" align="center">版权所有: XXX (c)2008-2015</td>
<!-- <td style="color:#ffffff;font-size: 12px;" align="center">版权所有: 百灵信息 CtentLing (c)2008-2015</td> -->
</tr>
<tr>
<td style="color:#ffffff;font-size: 12px;" align="center">网址：<a href="">http://www.xxxx.com</a></td>
<!-- <td style="color:#ffffff;font-size: 12px;" align="center">网址：<a href="http://www.centling.com">http://www.centling.com</a></td> -->
</tr>
</table>
</center>
<script type="text/javascript">
