...
<html>
	...
	<body style="overflow:hidden;">
		...
		<tr>
		<td height="75" style="background:url('<%=contextPath %>/images/top-5.png') repeat-x;">
...
<!--				<%if(clogin>0){ %>-->
<!--				<img border="0" alt="公司logo" src="<%=contextPath %>/showimg.do?imgId=<%=clogin %>&noImgPath=<%=Base64.getBase64FromString(this.getServletContext().getRealPath("/images/syslogin.png"))%>" style="height: 50px;width: auto">-->
<!--				<%}else{ %>-->
<!--				<img border="0" alt="公司logo" src="<%=contextPath %>/images/syslogin.png" style="height: 50px;width: auto">-->
<!--				<%} %>-->
<!--			</td>-->
			<td style="padding-left:5px;padding-right:5px" valign="top">
			
				<img border="0" alt="公司logo" src="" style="height: 50px;width: 200px">
					...
					<div class="div_content_bottom">
						...
						String style = "";
							...
							for(int i=0;i<userModuleMethods.size();i++){
								...
								<tr>
								<%}%>
								<td valign="middle" align="center" width="<%=(ConstWords.IndexLeftWidth-row*8)/row %>">
								<%
		...
		<td height="30" style="background:#054376;">
			...
			<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td align="right" style="padding-right:5px;" width="auto" valign="middle">
