	...
	<div class="formTitle">设置java代码及配置文件相关信息</div>
	    <table class="inputtable" border="0">
			 ...
			 <tr>
				<th><em>*</em>功能块名称</th>
				<td colspan="3">
					<input type="text" style="width:220px;" id="moduleName" name="moduleName" must="功能块名称不能为空！" formust="moduleNameMust" value="<%=request.getAttribute("moduleName")==null?"":request.getAttribute("moduleName")%>">
