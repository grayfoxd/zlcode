...
function submit(isContinue) {
	...
	dwrPersonalProcessService.completeLeaveTaskForApplyer(<%=taskId%>,isContinue,applyTxt,getLeaveinfo(),callback);
}
	...
	<tr>
		<td>
			<div style="display:none;margin-right:10px;" id="btnsubmit">
				<btn:btn onclick="submit('true');" value="提 交 " imgsrc="../../images/fileokico.png" title="提交" />
			</div>
		</td>
		<td>
			<div style="display:none;margin-right:10px;" id="btnfinish">
			<btn:btn onclick="submit('false');" value="结 束 " imgsrc="../../images/winclose.png" title="结束" />
			</div>
		</td>
		<td>
		...
		<td>
			<div style="display:none;margin-right:10px;" id="btnhragree">
				<btn:btn onclick="hrCheck('true');" value="同 意 " imgsrc="../../images/png-1718.png" title="同意" />
			</div>
		</td>
		<td>
		...
		<td>
			<div style="display:none;margin-right:10px;" id="btnhrback">
				<btn:btn onclick="hrCheck('false');" value="驳 回 " imgsrc="../../images/winclose.png" title="驳回"/>
			</div>
		</td>
