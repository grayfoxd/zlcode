...
<body class="inputcls">
	...
	<table align="center">
		<tr>
			<td><btn:btn onclick="savetmp()" value="草 稿 "  imgsrc="../../images/png-1718.png" title=""></btn:btn></td>
    		<td style="width: 10px;"></td>
			<td><btn:btn onclick="save()" value="提 交 " imgsrc="../../images/png-1718.png" title="保存申请信息"></btn:btn></td>
			<td style="width: 10px;"></td>
