	...
	<body>
		...
		<td height="75" style="background:url('<%=contextPath %>/images/top-5.png') repeat-x;">
			...
			<td style="padding-left:5px;padding-right:5px" valign="center">
				<img border="0" alt="公司logo" src="" style="height: 60px;width: 200px">
			</td>
				...
				<tr>
					<td id="split_l" style="width:200px;">
						...
						<script type="text/javascript">
							...
							var tree = new WebFXTree("CTOA");
							tree.add(new WebFXLoadTreeItem("系统配置管理", "index_menu.xml"));
							document.write(tree);
