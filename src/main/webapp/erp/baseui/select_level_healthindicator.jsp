...
window.onload = function(){
	...
	var tree = new WebFXLoadTree("指标目录","<%=request.getContextPath()%>/erp/baseui/i_health_indicator_tree_select.jsp?code=-2&treetype="+treetype+"");
...
function healthIndicatorIdclick(dialogId,myfrmname,method){
	treeclick(myfrmname);
