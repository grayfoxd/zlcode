...
window.onload = function(){
	...
	var tree = new WebFXLoadTree("项目目录","<%=request.getContextPath()%>/erp/baseui/i_phy_item_tree_select.jsp?code=-2&treetype="+treetype+"");
...
function phyItemIdclick(dialogId,myfrmname,method){
	treeclick(myfrmname);
