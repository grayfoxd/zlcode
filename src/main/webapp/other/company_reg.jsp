...
<%@page import="com.centling.common.util.file.FileTool"%>
...
<a href="<%=path %>/help/help_index.jsp" class="tit" target="_blank">帮助</a>&nbsp;&nbsp;
</td>
</tr>
</table>
...
<div style="font-size: 16px;font-family: Microsoft YaHei, 宋体, Segoe UI, verdana, arial;color: #fefefe">欢迎注册品互网络基础应用管理平台！请填写相关申请信息或者访问<a href="http://www.centling.com" target="_blank" class="regtit">官方网站</a>获取更多信息。</div>
</td>
...
<td width="944">
		...
		<td style="width: 150px;padding-right: 10px;" align="right"></td>
		<td style="padding-left: 10px;" colspan="2">
		<input type="checkbox" id="tiaokuan" checked="checked" onclick="changesubbtn(this)"><label for="tiaokuan">我已阅读并接受“<a href="javascript:void(0)" onclick="openwin();" style="color: #1457B5">服务条款</a>”</label>
		</td>
		</table>
...
<script type="text/javascript">
 ...
 function openwin(){
 	window.open("<%=path%>/other/termsforservice.jsp", "服务条款", "height=550, width=800, toolbar= no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,top=100,left=300");
 }
