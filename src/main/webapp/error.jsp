...
<%@page import="com.centling.core.iservice.ISysProcessService"%>
<%@page import="com.centling.common.module.SessionUser"%>
<%@page import="com.centling.common.util.LoginContext"%>
<%@page import="com.centling.core.pojo.SysException"%>
		...
		<table cellSpacing="5" width="90%" align="center" border="0" cepadding="0" style="line-height: 25px;">
			<tr>
				...
				<td>
					...
					<hr style="color:#c1c1c1;">
					<p>
						☉ 如果您对系统有任何疑问、建议，请联系管理员 : <a href="mailto:service@centling.com"> <font color="#336699">service@centling.com</font> </a>
					</p></td>
			</tr>
		</table>
	</div>
