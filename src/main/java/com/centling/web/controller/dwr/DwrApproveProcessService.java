...
import com.centling.common.activiti.ProcessDefinitionCache;
import com.centling.common.module.ApproveProcessBean;
import com.centling.common.module.HistoricProcessInstanceBean;
import com.centling.common.module.ProcessInstanceBean;
import com.centling.common.module.ProcessModelBean;
import com.centling.common.module.ResultBean;
import com.centling.common.pages.Pager;
import com.centling.common.pages.PagerHelper;
import com.centling.common.util.DateTimeTool;
...
import com.centling.core.iservice.IApproveProcessService;
...
public class DwrApproveProcessService {
	...
	public ResultBean updateSysProcessConfig(ServletContext context, HttpServletRequest request, SysProcessConfig sysProcessConfig) {
		SysProcessConfig tmp = approveService.getSysProcessConfigByPk(sysProcessConfig.getPrimaryKey());
	...
	public ResultBean updateSysProcessType(ServletContext context, HttpServletRequest request, SysProcessType sysProcessType) {
		SysProcessType tmp = approveService.getSysProcessTypeByPk(sysProcessType.getPrimaryKey());
		String empid = UtilTool.getEmployeeId(request);
