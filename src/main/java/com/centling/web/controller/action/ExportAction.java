package com.centling.web.controller.action;
...
import com.centling.common.util.file.office.ExcelExport;
import com.centling.common.util.file.office.WordExport;
...
public class ExportAction {
	...
	public void exportAnnounce(long id, HttpServletRequest request, HttpServletResponse response, ModelMap model){
		try {
			...
			String fileName = wordExport.exportAnnounce(map);
