...
public class EnumUtil {
	...
	public enum TRSVEL_TASK_ID {
		...
		private TRSVEL_TASK_ID(String id, String valueName) {
			this.id = id;
			this.valueName = valueName;
		}
	}
	...
	public enum LEAVE_TASK_ID {
		...
		private LEAVE_TASK_ID(String id, String valueName) {
			this.id = id;
			this.valueName = valueName;
		}
	}
	...
	public enum TASK_TODO_STATUS {
		CLAIM(1, "未签收"), TODO(2, "已签收");

		public int value;
		public String valueName;

		private TASK_TODO_STATUS(int value, String valueName) {
			this.value = value;
			this.valueName = valueName;
		}
	 ...
	 * 体检项目在目录树中是否为叶子结点
	 * 
	 * @author eric.jin  1 是叶子结点  2不是叶子结点
	 */
	public enum PHY_ITEM_IS_LEAF {
		Vaild(1, "是"), No_Vaild(2, "否");

		public int value;
		public String valueName;

		private PHY_ITEM_IS_LEAF(int value, String valueName) {
			this.value = value;
			this.valueName = valueName;
		}
	 ...
	 * @author eric.jin  1 是叶子结点  2不是叶子结点
	 */
	public enum PHY_ITEM_GENDER {
		Male(1, "男"), Female(2, "女"), Both(3, "全部");

		public int value;
		public String valueName;

		private PHY_ITEM_GENDER(int value, String valueName) {
			this.value = value;
			this.valueName = valueName;
		}
