...
import com.centling.common.code.component.Component;
import com.centling.common.code.component.ComponentFactory;
...
public class CreatePage {
	...
	private String getAddPageString() throws ClassNotFoundException {
		...
		sb.append("<%@include file=\"/erp/common.jsp\" %>\n");
	...
	private String getManagePageString() throws ClassNotFoundException {
		...
		sb.append("    var box = new Sys.msgbox(\"明细查看\",\"<%=contextPath%>/" + folderName + "/" + pojoShortName + "_detail.jsp?pk=\"+obj.value);\n");
		sb.append("    box.show();\n");
		sb.append("}\n");

		sb.append("function edit(pk){\n");
		sb.append("    openMDITab(\"<%=contextPath%>/" + folderName + "/" + pojoShortName + "_add.jsp?pk=\"+pk+\"&tab=\"+getMDITab());\n");
		sb.append("}\n");
		...
		sb.append("    openMDITab(\"<%=contextPath%>/" + folderName + "/" + pojoShortName + "_add.jsp?tab=\"+getMDITab());\n");
		sb.append("}\n");
