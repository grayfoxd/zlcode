...
public class CreateTree {
	...
	public static String getTreeSelectXmlPageString(String dwrName,String pojoClass,String folderName,String pojoShortName) {
		...
		sb.append("<%@page import=\"com.centling.common.util.UtilTool\"%>\n");
		sb.append("<%@page import=\"com.centling.core.pojo." + pojoClass + "\"%>\n");
		sb.append("<%@page import=\"com.centling.web.controller.dwr." + dwrClassName + "\"%>\n");
		sb.append("<%\n");
